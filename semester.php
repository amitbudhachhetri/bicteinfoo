...
<div class="container">
    ...
    <div align = "left">
        ...
        <table border ="1">
            ...
            <?php
            $result = $db->prepare("SELECT * FROM model_question WHERE sem_id = $a");
            $result->execute();
    ...
    <div align="left"> 
        ...
        <table border ="1" >
            ...
            <?php
            $result = $db->prepare("SELECT * FROM notes WHERE sem_id = $a");
            $result->execute();
            for($i=0; $row = $result->fetch(); $i++){   
                $a = $row['sem_id'];
                $b = $row['sub_id'];
    ...
    <div align = "right">
        ...
        <table border ="1" >
            ...
            <?php
            $result = $db->prepare("SELECT * FROM project WHERE sem_id = $a");
            $result->execute();
            for($i=0; $row = $result->fetch(); $i++){   
                $a = $row['sem_id'];
                $b = $row['sub_id'];
